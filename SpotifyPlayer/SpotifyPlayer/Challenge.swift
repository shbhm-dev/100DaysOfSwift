...
class Challenge: UIViewController {
    ...
    func setupViews() {
        ...
        trackLabel.topAnchor.constraint(equalTo: albumImage.bottomAnchor, constant: 10).isActive = true
        
        albumLabel.centerXAnchor.constraint(equalTo: view.centerXAnchor).isActive = true
        albumLabel.topAnchor.constraint(equalTo: trackLabel.bottomAnchor, constant: 10).isActive = true
        
        playButton.topAnchor.constraint(equalTo: albumLabel.bottomAnchor, constant: 10).isActive = true
        playButton.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 5).isActive = true
